...
const COMPLETIONS = [
    ...
    { n:'restartScene',      m:'scene',      v:'restartScene()', d:'Reset the current scene without leaving play mode. Fast-path: resets objects in-place, no full rebuild.'},
    { n:'dontDestroyOnLoad', m:'scene',      v:'dontDestroyOnLoad()', d:'Mark this object to survive Restart Scene and Switch Scene. Call from onStart(). Object + script state persist; onStart does not re-fire. Destroyed on full Stop.'},
    ...
    { n:'physics.isOnGround',          m:'physics (kinematic)', v:'physics.isOnGround', d:'True if on a floor contact ≤ groundAngle from horizontal. Mutually exclusive with physics.isOnSlope. Read-only.'},
    ...
    { n:'physics.isOnSlope',           m:'physics (kinematic)', v:'physics.isOnSlope', d:'True if on a floor contact steeper than groundAngle. Mutually exclusive with physics.isOnGround. Read-only.'},
    { n:'physics.slopeAngle',          m:'physics (kinematic)', v:'physics.slopeAngle', d:'Tilt angle in degrees of the slope under this body. 0 when not on a slope. Read-only.'},
    { n:'physics.setGroundAngle',      m:'physics (kinematic)', v:'physics.setGroundAngle(${1:45})', d:'Set the angle threshold splitting isOnGround (≤ limit) from isOnSlope (> limit). Default 45.'},
    { n:'physics.groundAngle',         m:'physics (kinematic)', v:'physics.groundAngle', d:'Current ground-angle threshold in degrees. Default 45. Read-only.'},
...
(function() {
    const _SB_ENGINE = new Set(["addImpulse", "aiChat", "applyAngularImpulse", "applyForce", "applyImpulse", "axisH", "axisV", "bounceX", "bounceY", "boundsClamp", "broadcastAll", "broadcastGroup", "cameraFollow", "cameraMoveTo", "cameraShake", "onRotate", "setCameraFOV", "getCameraFOV", "cameraZoomTo", "cameraUnfollow", "cancelRepeat", "canSee", "chatPlayer", "chatSay", "clearTint", "cloneInPlace", "cloneObject", "cloneSelf", "createJoystick", "currentAnimation", "currentScene", "currentSceneIndex", "destroyAfter", "destroyAllJoysticks", "destroyObject", "destroySelf", "distanceTo", "dragObject", "drawDebugCircle", "drawDebugLine", "drawText", "error", "fadeIn", "fadeOut", "find", "findAllInGroup", "findAllWithTag", "findWithTag", "flipX", "flipY", "flee", "forever", "getAlpha", "getAmmo", "getCameraX", "getCameraY", "getCloneId", "getGroup", "getHealth", "getMaxAmmo", "getMaxHealth", "getObjectsInRadius", "getRotation", "getScaleX", "getScaleY", "getSceneName", "getState", "getTag", "getTime", "getTint", "getTouches", "getVelX", "getVelY", "getVisible", "getX", "getY", "getZOrder", "getSlopeAngle", "GameSave", "globalVar", "dontDestroyOnLoad", "gotoScene", "groundAngle", "heal", "hide", "hideChat", "hitFlash", "inFOV", "inRangeOf", "invincible", "isClone", "isPlayingAnimation", "isDead", "isDragging", "isInvincible", "isKeyDown", "isKeyJustDown", "isKeyJustUp", "isOnCeiling", "isOnGround", "isOnSlope", "isOnWall", "isStuck", "isTouching", "isWalking", "lastKnownPos", "lockRotation", "log", "lookAt", "makeDraggable", "makeThrowable", "throwObject", "mouseDown", "mouseJustDown", "mouseX", "mouseY", "move", "moveForward", "moveTo", "objectShake", "offScreen", "onBecomeHidden", "onBecomeVisible", "onCloneStart", "onCollisionEnter", "onCollisionExit", "onCollisionStay", "onDamage", "onDeath", "onDestroy", "onHeal", "onJump", "onKeyDown", "onKeyUp", "onLand", "onMessage", "onMouseClick", "onMouseEnter", "onMouseLeave", "onOverlapEnter", "onOverlapExit", "onPinch", "onReload", "onScreenEnter", "onScreenExit", "onStart", "onStateEnter", "onStateExit", "onStop", "onSwipe", "onTap", "onUpdate", "onceAfter", "opts", "overlaps", "overlapsAllWithTag", "overlapsTag", "pauseAnimation", "pauseScene", "playAnimation", "pursue", "raycast", "raycastAll", "raycastFromSelf", "reload", "repeat", "restartScene", "resumeScene", "say", "sceneCount", "sceneSettings", "sceneVar", "screenMouseX", "screenMouseY", "screenToWorld", "selfName", "sendMessage", "setAlpha", "setAmmo", "setAngularVelocity", "setCollision", "setCollisionCategory", "setCollisionMask", "setGravityScale", "setGroup", "setGroundAngle", "setHealth", "setImmovable", "setMaxAmmo", "setMaxHealth", "setPhysicsType", "setPhysicsVelocity", "setRotation", "setRotationLocked", "setScaleX", "setScaleY", "setSensor", "setState", "setTag", "setTint", "setVelocity", "setVisible", "setX", "setY", "setZOrder", "slopeAngle", "show", "showChat", "soundPlay", "soundStop", "soundStopAll", "spawnCopy", "spawnObject", "stopAnimation", "stopDrag", "stopMovement", "stopPhysics", "stopWalking", "takeDamage", "think", "touchCount", "touchJustStarted", "trackTarget", "triggerJump", "tween", "unlockRotation", "velocityX", "velocityY", "velX", "velY", "vx", "vy", "wait", "walkTo", "walkToObject", "wander", "warn", "worldToScreen", "wrap"]);
...
function _sidebarHTML() {
    ...
    const G = [
        ...
        ['Scene', [
            ...
            'restartScene()                              // fast reset (in-place)',
            'dontDestroyOnLoad()                         // object survives scene switches',
        ...
        ['Physics (helpers)', [
            ...
            'isOnSlope()  /  getSlopeAngle()',
            'setGroundAngle(45)  — splits ground vs slope',
            'velX  /  velY  — actual body velocity',
            'applyForce(fx, fy)',
            'applyImpulse(ix, iy)',
...
// PHYSICS:     applyForce(fx,fy)     applyImpulse(ix,iy)    isOnGround()  isOnSlope()  setGroundAngle(45)
