...
const COMPLETIONS = [
    ...
    { n:'isOnSlope',             m:'physics (kinematic)', v:'isOnSlope()', d:'True if this body is touching a diagonal slope surface (not flat enough for ground, not steep enough for a wall). Use to play a slide animation or apply slope friction.'},
    ...
    { n:'physics.isOnSlope',           m:'physics (kinematic)', v:'physics.isOnSlope', d:'True if this body is touching a diagonal slope surface. Read-only.'},
...
function _sidebarHTML() {
    ...
    const G = [
        ...
        ['Physics Direct', [
            ...
            'physics.isOnWall  /  physics.isOnSlope',
            'physics.stop()',
