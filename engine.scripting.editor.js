...
const COMPLETIONS = [
    ...
    { n:'makeDraggable opts',   m:'drag',  v:"makeDraggable({ smooth:${1:16}, clamp:${2:true}, scale:${3:1.1} })", d:'Draggable with options: smooth (lerp speed), clamp (bounds), scale (pop effect).' },
    ...
    { n:'makeThrowable opts',   m:'throw', v:"makeThrowable({ speed:${1:1}, maxSpeed:${2:25}, clamp:${3:false}, scale:${4:1.08} })", d:'Throwable with options: speed multiplier, maxSpeed cap, scale on grab.' },
    { n:'makeThrowable onThrow',m:'throw', v:"makeThrowable({ speed:${1:1}, onThrow:(vx,vy) => { ${2:log(vx,vy)} } })", d:'Throwable with a callback that fires with (vx, vy) when the object is released.' },
    { n:'throwObject',          m:'throw', v:"throwObject(find('${1:Ball}'))", d:'Throw another object using the current drag velocity.' },
    { n:'throwObject opts',     m:'throw', v:"throwObject(find('${1:Ball}'), { speed:${2:1.5}, maxSpeed:${3:30} })", d:'Throw another object with custom speed and maxSpeed options.' },
