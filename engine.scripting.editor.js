...
const COMPLETIONS = [
    ...
    // Scene
    { n:'gotoScene',              m:'scene',  v:"gotoScene('${1:SceneName}')", d:'Switch to another scene by name or index. Add transition name + duration: gotoScene("L2","fade",0.5).' },
...
function _sidebarHTML() {
    ...
    const G = [
        ...
        ['Scene', [
            ...
            '// 3rd arg = total duration in seconds (default 0.5)',
