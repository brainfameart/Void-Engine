...
const API_NAMES = new Set([
    ...
    "sendMessage","broadcastGroup","broadcastAll",
    "find","findWithTag","findAllWithTag","findAllInGroup",
    "overlaps","overlapsTag","overlapsAllWithTag",
    "destroySelf","destroyObject","destroyAfter",
    "gotoScene","pauseScene","resumeScene","restartScene","dontDestroyOnLoad",
    ...
    "getVelX","getVelY","velX","velY","stopPhysics","setImmovable",
    "isOnGround","isOnCeiling","isOnWall","isOnSlope","getSlopeAngle","slopeAngle","setGroundAngle","groundAngle",
...
const TYPO_MAP = {
    ...
    "restartscene":"restartScene","currentscene":"currentScene","dontdestroyonload":"dontDestroyOnLoad","dontdestroy":"dontDestroyOnLoad",
